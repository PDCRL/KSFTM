...
/*
 * Fuctions created to sync with STAMP benchmark.
 * */
...
/*
 * SWTM class that provides the shared memory to all the transactions
 * */
class SWTM
{
 ...
 * inherits the SWTM class
 * 
 * 
 * */
class KSFTM : public virtual SWTM	
{
	public:
	//Constructor
